...
# Nhập username TikTok không có dấu @
username = input('\033[34mNhập Username TikTok (Không Nhập @): ')

while True:
    # Gửi yêu cầu GET để lấy session và token
    headers = {
    ...
    try:
        ...
        if search.get('success') == True:
            ...
            if send_follow.get('o') == 'Success!' and send_follow.get('success') and send_follow.get('type') == 'success':
                print('\033[30mTăng \033[32mFollow \033[33mTik \033[31mTok \033[34mThành \033[35mCông')
                continue
                ...
                try:
                    ...
                    for i in range(giay, 0, -1):
                        print(f'\033[33mVui \033[34mLòng \033[31mChờ \033[31m{i} \033[35mGiây...', end='\r')
                        time.sleep(1)
                    continue
                except:
                    print('\033[31mLỗi Không Xác Định               ')
                    continue
    except:
        print('\033[31mLỗi Không Xác Định               ')
        continue